...
const sections = [
  {
    title: 'Anbieterkennzeichnung gemäß Telemediengesetz (TMG):',
    content: [
  ...
  {
    title: 'Kontakt und Vertretungsberechtigte:',
    content: ['Geschäftsführer: Kai Künne, Fatih Temel'],
  },
  {
    title: 'Kontakt E-Mail:',
    content: ['info@getplaced.de'],
    isEmail: true,
  },
];
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="mt-12">
            <h2 className="text-3xl font-bold text-work-blue mb-6">
