...
const features = [
  {
    ...
    description: "PLACED bietet eine aktuelle Übersicht über den Stellenmarkt.",
    points: [
    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-8 md:px-16 space-y-20">
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          <h2 className="tracking-tight text-work-blue">Die KI-Revolution im Vertrieb</h2>
          <p className="text-muted-foreground leading-relaxed">
            PLACED revolutioniert den Personalvertrieb mit KI-gestützter Technologie. Unsere Plattform maximiert Ihre
            Vermittlungsquote durch präzises Matching und automatisierte Prozesse.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <FadeIn
              key={feature.title}
              delay={i * 0.1}
              className="p-6 rounded-xl glass-effect bg-card/80 transition-colors shadow-sm space-y-4"
            >
              ...
              <h3 className="text-foreground text-center">{feature.title}</h3>
            ...
            <div className="relative max-w-5xl mx-auto px-4 sm:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="glass-effect bg-white/70 rounded-2xl shadow-lg p-8 flex flex-col items-center text-center transition-transform hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <p className="text-base text-muted-foreground leading-relaxed">
                    Überzeugende Vertriebsgespräche basierend auf spezifischen Kandidaten-CVs und dem Match mit der
                    Stelle. Sagen Sie genau das Richtige, zur richtigen Zeit.
                  </p>
                </div>
              </div>
        ...
        <FadeIn delay={0.3}>
          <div className="max-w-4xl mx-auto py-16 text-center space-y-6">
            <h3 className="text-center text-2xl font-bold mb-6">100% konform nach DSGVO & EU AI Act</h3>
